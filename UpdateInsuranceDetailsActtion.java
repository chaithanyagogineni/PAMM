 ...
 */
public class UpdateInsuranceDetailsActtion extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			flag = new UserPersonalDelegate()
					.updateInsurenceDetails(insuranceTO);
			if (flag) {
				request.setAttribute("status",
						UtilConstants._UPDATE_INSURANCE_DETAILS);
				return mapping.findForward("success");
			} else {
				request.setAttribute("status",
						UtilConstants._UPDATE_INSURANCE_DETAILS_FAIL);
